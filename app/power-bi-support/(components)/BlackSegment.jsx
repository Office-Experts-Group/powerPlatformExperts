      ...
      <AnimateOnScroll animation="slide-left" delay={0.1} duration={1.2}>
        <div className={styles.content}>
          ...
          <div className={`${styles.text} ${styles.marginText}`}>
            <p>
            When your Power BI solutions encounter challenges, our expert team steps in with rapid, effective solutions. We excel at identifying and resolving performance bottlenecks in complex dashboards, ensuring your critical reports load quickly when decision-makers need them most.
            </p>
      ...
      <AnimateOnScroll animation="fade-down" delay={0.3} duration={1.2}>
        <div className={styles.points}>
          <div className={styles.point}>
            ...
            <strong>Dashboard Performance Optimisation -</strong> We identify and resolve performance bottlenecks in complex dashboards
            </p>
          </div>
          ...
          <div className={styles.point}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Data Connectivity Issues -</strong> Expert resolution of connection problems with diverse data sources</p>
          </div>
          ...
          <div className={styles.point} style={{ marginBottom: ".5rem"}}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Report Rendering Errors -</strong> Quick diagnosis and repair of visualisation display issues</p>
          </div>
          ...
          <div className={styles.point} style={{ marginBottom: ".5rem"}}>
            ...
            />
            <p className={styles.centerText}>
            <strong>DAX Formula Troubleshooting -</strong> Correction and optimisation of complex calculations</p>
          </div>
          ...
          <div className={styles.point} style={{ marginBottom: ".5rem"}}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Gateway Configuration -</strong> Resolution of on-premises data gateway issues</p>
          </div>
        </div>
      </AnimateOnScroll>
    </section>
