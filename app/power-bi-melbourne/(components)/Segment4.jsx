      ...
      >
        ...
        <AnimateOnScroll animation="scale-up" duration={1} delay={0.2}>
          <div className="image-wrapper">
            <Image
              src={tableGraph}
              alt="Power BI dashboard showing Melbourne business data"
              width={300}
              height={200}
            />
          </div>
