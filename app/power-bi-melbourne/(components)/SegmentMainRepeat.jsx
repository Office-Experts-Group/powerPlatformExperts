      ...
      <div className={styles.contentWrapper}>
        <AnimateOnScroll animation="fade-up" duration={1} delay={0.3}>
          <div className={styles.content}>
            ...
            <p>
              From Southbank, Docklands, Carlton, to Frankston, we provide
              comprehensive Power BI solutions. We also work with businesses
              throughout regional Victoria, offering flexible engagement models
              including on-site visits, remote consulting, and hybrid
              arrangements. Our local presence means we understand Melbourne's
              business landscape.
            </p>
