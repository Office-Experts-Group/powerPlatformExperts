      ...
      <div className={styles.contentWrapper}>
        <AnimateOnScroll animation="fade-up" duration={1} delay={0.3}>
          <div className={styles.content}>
            <h2>Comprehensive Power BI Services in Melbourne</h2>
            <p>
              From the CBD to Parramatta, North Sydney, and the Sutherland
              Shire, we deliver comprehensive Power BI solutions. We also work
              with businesses across regional New South Wales, offering flexible
              engagement options including on-site visits, remote consulting,
              and hybrid arrangements. Our local presence means we understand
              Sydney's diverse business landscape.
            </p>
