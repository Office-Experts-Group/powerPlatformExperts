      ...
      <AnimateOnScroll animation="slide-right" delay={0} duration={1}>
        <div className={styles.content}>
          <div className={styles.underline}>
            <p>Your Power Platform Specialists</p>
          </div>
          <h2>Microsoft Power Platform Solutions for Australian Businesses</h2>
          <p className={styles.themeText}>
            With decades of combined experience, our certified consultants
            deliver scalable solutions using Power Apps, Power Automate, Power
            BI, and Power Pages—empowering businesses across Australia to
            streamline operations and gain insights.
          </p>
          <div className={styles.text}>
            <p>
              We combine low-code development expertise along with programming,
              development and a deep understanding of business
              processes—enabling us to create tailored digital tools that
              automate workflows, connect systems, and improve efficiency.
            </p>
          </div>
