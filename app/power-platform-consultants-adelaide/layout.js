...
export const metadata = {
  ...
  description:
    "Leading Power Platform consultants in Adelaide. For over 25yrs Powerplatfom Experts have supercharged business efficiency with power bi, power automate, pages, apps and the entire Office suite  ",
