      ...
      <AnimateOnScroll animation="slide-left" delay={0.1} duration={1.2}>
        <div className={styles.content}>
          ...
          <div className={`${styles.text} ${styles.marginText}`}>
            <p>
            We're here to support your Power Platform journey well beyond the initial setup. Our team provides continuous guidance and technical support to keep your solutions performing at their best.
            </p>
      ...
      <AnimateOnScroll animation="fade-down" delay={0.3} duration={1.2}>
        <div className={styles.points}>
          <div className={styles.point}>
            ...
            <strong>Performance Tuning -</strong> We help optimise workflows, dashboards, and apps to ensure speed, reliability, and efficiency.
            </p>
          </div>
          ...
          <div className={styles.point}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Issue Resolution -</strong> Fast, expert assistance to diagnose and resolve errors or unexpected behaviours.</p>
          </div>
          ...
          <div className={styles.point} style={{ marginBottom: ".5rem"}}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Feature Enhancements -</strong> Support for rolling out new functionality, updates, and integrations as your needs evolve.</p>
          </div>
          ...
          <div className={styles.point} style={{ marginBottom: ".5rem"}}>
            ...
            />
            <p className={styles.centerText}>
            <strong>User Training -</strong> Practical, role-based training to upskill your team and promote confident platform usage.</p>
          </div>
        </div>
      </AnimateOnScroll>
    </section>
