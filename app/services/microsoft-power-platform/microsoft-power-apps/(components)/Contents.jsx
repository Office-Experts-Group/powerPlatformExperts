      ...
      {isHidden ? (
        ...
        >
          ...
          <a
            ...
            onClick={(e) => handleLinkClick(e, "#microsoft-partner")}
          >
          ...
          <a
            href="#existing-data"
            onClick={(e) => handleLinkClick(e, "#existing-data")}
          >
            <div className={styles.contentLink}>
              <p>Existing Data</p>
            </div>
          </a>
          <a href="#unlock" onClick={(e) => handleLinkClick(e, "#unlock")}>
            <div className={styles.contentLink}>
              <p>Mobility with Apps</p>
            </div>
          </a>
          <a
            href="#custom-solutions"
            onClick={(e) => handleLinkClick(e, "#custom-solutions")}
          >
            <div className={styles.contentLink}>
