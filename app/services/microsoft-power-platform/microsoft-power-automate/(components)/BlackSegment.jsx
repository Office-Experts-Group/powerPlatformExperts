      ...
      <AnimateOnScroll animation="slide-left" delay={0.1} duration={1.2}>
        <div className={styles.content}>
          <div className={styles.title}>
            ...
            <h2>Effortless Task Automation with Power Automate</h2>
          </div>
          <div className={styles.text}>
            <p>
              Think of Power Automate as a robotic virtual assistant, expediting
              manual processes across applications and data sources . Power
              Automate can automatically trigger actions. Our experts seamlessly
              connect workflows, autonomously triggering actions like sending
              emails, updating databases and sending alerts to your team
              ultimately increasing efficiency and boosting productivity.
            </p>
