    ...
    >
      {isHidden ? (
        ...
        >
          ...
          <h3>Contents</h3>
          <a
            href="#enhance-your-business-productivity"
            onClick={(e) =>
              handleLinkClick(e, "#enhance-your-business-productivity")
            }
          >
            <div className={styles.contentLink}>
              <p>Enhance your Business Productivity</p>
            </div>
          </a>
          <a
            href="#data-visualisation"
            onClick={(e) => handleLinkClick(e, "#data-visualisation")}
          >
            <div className={styles.contentLink}>
              <p>Empower Your Data Visualisations</p>
            </div>
          </a>
          <a
            href="#streamlined-data-accessibility"
            onClick={(e) =>
              handleLinkClick(e, "#streamlined-data-accessibility")
            }
          >
            <div className={styles.contentLink}>
              <p>Streamlined Data Accessibility</p>
            </div>
          </a>
          <a
            href="#maximise-with-expert-assistance"
            onClick={(e) =>
              handleLinkClick(e, "#maximise-with-expert-assistance")
            }
          >
            <div className={styles.contentLink}>
              <p>Maximise with Expert Assistance</p>
            </div>
          </a>
        </div>
      )}
