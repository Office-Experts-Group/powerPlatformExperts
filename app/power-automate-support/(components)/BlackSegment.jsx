      ...
      <AnimateOnScroll animation="slide-left" delay={0.1} duration={1.2}>
        <div className={styles.content}>
          ...
          <div className={`${styles.text} ${styles.marginText}`}>
            <p>
            When your flows break or don't behave as expected, we provide rapid resolution with minimal downtime. From fixing logic errors to resolving integration issues, we ensure your automations stay dependable and effective.
            </p>
      ...
      <AnimateOnScroll animation="fade-down" delay={0.3} duration={1.2}>
        <div className={styles.points}>
          <div className={styles.point}>
            ...
            <strong>Flow Error Diagnosis –</strong> Identify and resolve errors with complex or broken workflows
            </p>
          </div>
          ...
          <div className={styles.point}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Connector & API Troubleshooting –</strong> Fix authentication issues and third-party service connections.</p>
          </div>
          ...
          <div className={styles.point} style={{ marginBottom: ".5rem"}}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Logic & Conditions Debugging –</strong> Ensure conditional logic behaves as intended.</p>
          </div>
          ...
          <div className={styles.point} style={{ marginBottom: ".5rem"}}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Run History Analysis –</strong> Investigate failed runs and optimise performance.</p>
          </div>
        </div>
      </AnimateOnScroll>
    </section>
