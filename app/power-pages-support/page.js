      ...
      potentialAction: [
        {
          "@type": "ReadAction",
          target: [
            "https://www.powerplatformexperts.com.au/power-pages-support",
          ],
        },
      ],
    },
...
const jsonLd = {
  ...
  description:
    "Professional Power Pages support services including troubleshooting, performance optimisation, maintenance, and feature enhancements for Australian businesses.",
  offers: {
    "@type": "Offer",
  ...
  serviceOutput:
    "Reliable, secure, and user-friendly Power Pages portals with optimised performance and seamless user experience.",
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Power Pages Support Services",
    itemListElement: [
