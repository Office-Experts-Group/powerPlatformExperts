      ...
      <AnimateOnScroll animation="slide-left" delay={0.1} duration={1.2}>
        <div className={styles.content}>
          <div className={styles.title}>
            ...
            <h2>Troubleshooting & Technical Support</h2>
          </div>
          <div className={`${styles.text} ${styles.marginText}`}>
            <p>
            When issues affect your live site, we provide rapid support to minimise downtime and ensure a seamless experience for your users. From form errors to portal configuration issues, our team delivers fast resolutions and future-proof fixes.
            </p>
      ...
      <AnimateOnScroll animation="fade-down" delay={0.3} duration={1.2}>
        <div className={styles.points}>
          <div className={styles.point}>
            ...
            <strong>Site Performance Issues -</strong> We diagnose and resolve slow-loading pages, rendering glitches, or responsiveness problems.
            </p>
          </div>
          ...
          <div className={styles.point}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Authentication & Permissions -</strong> Fixes for login issues, user roles, and secure access to Dataverse data.</p>
          </div>

          <div className={styles.point} style={{ marginBottom: ".5rem"}}>
            <Image
              src={migrateIcon}
              alt="Old version icon"
              width={30}
            ...
            />
            <p className={styles.centerText}>
            <strong>Form & Workflow Errors -</strong> Debugging broken forms, automations, or integrations with Power Automate.</p>
          </div>
          ...
          <div className={styles.point} style={{ marginBottom: ".5rem"}}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Content Display Problems -</strong> Troubleshooting content visibility, language settings, or navigation problems.</p>
          </div>
          ...
          <div className={styles.point} style={{ marginBottom: ".5rem"}}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Design & Layout Fixes -</strong> Addressing layout shifts, theme inconsistencies, or broken UI elements.</p>
          </div>
        </div>
      </AnimateOnScroll>
    </section>
