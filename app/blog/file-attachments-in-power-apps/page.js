  ...
  return (
    ...
    <div className={styles.blogContainer}>
      ...
      <div className={styles.blogContent}>
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/yC0W5am6M3Q?si=wlQ5FUzmmOka-J24" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        </div>
        ...
        <CodeBlock code={attachmentControlCode} language="javascript" />
        ...
        <CodeBlock code={flowTriggerCode} language="javascript" />
        ...
        <CodeBlock code={createFileCode} language="javascript" />
