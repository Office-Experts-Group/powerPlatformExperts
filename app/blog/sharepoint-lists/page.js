  ...
  return (
    ...
    <div className={styles.blogContainer}>
      ...
      <div className={styles.blogContent}>
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/Bea5aP-OpZg?si=PSVPw5o7augLSbfB" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        </div>
        ...
        <CodeBlock code={createListsCode} language="javascript" />
        ...
        <CodeBlock code={dataConnectionCode} language="javascript" />
        ...
        <CodeBlock code={filteringCode} language="javascript" />
        ...
        <CodeBlock code={savingChildRecordsCode} language="javascript" />
        ...
        <p>If you need professional support with sharepoint, be sure to get in contact with me at <Link href={'/'}> Powerplatform Experts.</Link></p>
      </div>
    </div>
    <Contact />
    </>
