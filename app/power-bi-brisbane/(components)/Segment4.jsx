      ...
      >
        <AnimateOnScroll animation="slide-left" duration={1} delay={0}>
          <div className={styles.content}>
            ...
            <p>
              Our Brisbane-based consultants have extensive experience across
              ...
              services on Queen Street to healthcare providers in the western
        ...
        <AnimateOnScroll animation="scale-up" duration={1} delay={0.2}>
          <div className="image-wrapper">
            <Image
              src={tableGraph}
              alt="Power BI dashboard showing Brisbane business data"
              width={300}
              height={200}
            />
          </div>
